...
1. 直接在 `manifest.json` 文件中添加以下内容
   ```json
      {"com.cysharp.unitask": "https://github.com/AlianBlank/com.cysharp.unitask.git"}
    ```
2. 在Unity 的`Packages Manager` 中使用`Git URL` 的方式添加库,地址为：https://github.com/AlianBlank/com.cysharp.unitask.git
